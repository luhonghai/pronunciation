...
public class LevelDAO extends DataAccess<Level> {
     ...
     * @throws Exception
     */
    public boolean updateLevel(String id, String name, String description, String color) throws Exception{
        ...
        Query q = pm.newQuery("javax.jdo.query.SQL", "UPDATE " + metaRecorderSentence.getTable() + " SET name=? , description=?, color=? WHERE id='"+id+"'");
        try {
