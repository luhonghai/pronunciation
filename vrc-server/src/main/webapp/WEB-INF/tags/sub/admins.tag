      ...
      <div class="modal-header">
        <div class="row">
          <div class="col-xs-12 col-md-10 col-md-offset-1">
            ...
            <form autocomplete="off" name="add" class="form-horizontal"
              ...
              <div class="form-group">
                ...
                <div class="col-xs-8  col-sm-9">
                  <input autocomplete="off" type="password" id="addpassword" name="addpassword" class="col-xs-8  col-sm-9 form-control">
          ...
          <div class="col-xs-12 col-md-10 col-md-offset-1">
            ...
            <form  autocomplete="off" name="Edit" class="form-horizontal"
              ...
              <div class="form-group">
                <label class="col-xs-4  col-sm-3 control-label">Password:</label>
                <div class="col-xs-8  col-sm-9">
                  <input autocomplete="off"  type="password" id="editpassword" name="editpassword" class=" form-control">
