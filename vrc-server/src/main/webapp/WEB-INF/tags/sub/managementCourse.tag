    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" id="openAddCourse" name="addCode">Add New Course</button>
              ...
              <div class="form-group">
                ...
                <div>
                  ...
                  <div class="col-xs-8  col-sm-9">
                    <input  type="text" id="addCourse" name="addCourse" class=" form-control" style="padding-left: 0px; margin-bottom: 5px;">
                  </div>
                </div>
                <div>
            ...
            <form name="Edit" class="form-horizontal"
              ...
              <div class="form-group">
                <div>
                  <label class="col-xs-4  col-sm-3 control-label ">Course:</label>
                  <div class="col-xs-8  col-sm-9">
                    <input  type="text" id="editCourse" name="editCourse" class=" form-control" style="padding-left: 0px; margin-bottom: 5px;">
                  </div>
                </div>
                <div>
                  <label class="col-xs-4  col-sm-3 control-label ">Description:</label>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h1 class="modal-title" align="center">Delete Course</h1>
      </div>
...
<script src="<%=request.getContextPath() %>/js/Lession/managementCourse.js"></script>
