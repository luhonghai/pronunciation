    ...
    <div class="row">
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input type="text" name="filter-lesson" id="lesson" class="form-control" placeholder="Title">
        </div>
      </div>
      <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-xs-12 col-md-10 col-md-offset-1">
            ...
            <form name="add" class="form-horizontal"
              ...
              <div class="form-group">
                <div class="row">
                  <label class="col-xs-4  col-sm-4 control-label ">Lesson:</label>
                ...
                <div class="row">
                  <label class="col-xs-4  col-sm-4 control-label ">Long description:</label>
                  <div class="col-xs-8  col-sm-8">
