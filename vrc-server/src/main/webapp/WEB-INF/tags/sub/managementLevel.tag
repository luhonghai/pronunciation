...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Level Management</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" name="filter-description" id="description" class="form-control"
            ...
            <div class="col-sm-3">
                ...
                <button type="button" id="button-filter" name="button-filter" class="btn btn-primary pull-right"
                        style="margin-top:24px"><i class="fa fa-search"></i> Filter
                </button>
            </div>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-responsive dt-responsive display nowrap"
                                   id="dataTables-example" cellspacing="0">
                                <thead>
                                <tr>
                                    <th>Level</th>
                                    <th>Description</th>
                        ...
                        <form name="add" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <div class="col-xs-8  col-sm-8">
                                        <textarea type="text" id="addDescription" name="addDescription" rows="3"
                                                  cols="50" class=" form-control"
                                                  style="padding-left: 0px;margin-bottom: 5px;"></textarea>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="col-xs-8  col-sm-8">
                                        <input type="text" id="addColor" name="addColor" class=" form-control"
                                               style="padding-left: 0px; margin-bottom: 5px;">
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="modal-footer">
                                <button type="button" name="yesadd" id="yesadd" class="btn btn-default" value="yes">
                                    Yes
                                </button>
                                <button type="button" name="closeadd" id="closeadd" class="btn btn-default"
                        ...
                        <form name="Edit" class="form-horizontal"
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <div class="col-xs-8  col-sm-8">
                                        <input type="text" id="editLevel" name="editLevel" class=" form-control"
                                               style="padding-left: 0px; margin-bottom: 5px;">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="col-xs-8  col-sm-8">
                                        <textarea type="text" id="editDescription" name="editDescription" rows="3"
                                                  cols="50" class=" form-control"
                                                  style="padding-left: 0px;margin-bottom: 5px;"></textarea>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="col-xs-8  col-sm-8">
                                        <input type="text" id="editColor" name="editColor" class=" form-control"
                                               style="padding-left: 0px; margin-bottom: 5px;">
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="modal-footer">
                                <button type="button" name="yesedit" id="yesedit" class="btn btn-default" value="yes">
                                    Yes
                                </button>
                                <button type="button" name="closeedit" id="closeedit" class="btn btn-default"
                                        data-dismiss="modal" value="Close">Close
                                </button>
        ...
        <div class="modal-content">
            ...
            <form name="form-delete">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" name="closedelete" id="closedelete" class="btn btn-default"
                            data-dismiss="modal" value="Close">Close
                    </button>
                </div>
            </form>
