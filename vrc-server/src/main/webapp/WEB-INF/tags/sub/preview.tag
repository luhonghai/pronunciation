<div id="preview-popup" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-md-8" id="mobile-view">
                            <div id="contain-data">
                                <div class='screen-detail' id="screen-level" style="display :block">
                                    <div class="header">
                                ...
                                <div class='screen-detail' id="screen-objective" style="display:none">
                                    <div class="header">
                                        <img src="/images/treeview/unpublished_button.gif" style="float:left;width:20px;height=20px;">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label>Select the relevant buttons to navigate through and preview the course
                                content.</label>
                            <label>Use the 'back' <img src='/images/treeview/unpublished_button.gif' style="width:24px;height: 24px"> button to return to the
