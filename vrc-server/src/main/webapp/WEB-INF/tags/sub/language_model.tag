...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Language model</h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" id="btnPopup" name="addCode">Generate</button>
        </div>
        <!-- /.panel-heading -->
        <div class="panel-body">
          <div id="generate-log" style="max-height: 300px; overflow-y: scroll"></div>
      ...
      <div class="modal-header">
        <div class="row">
          <div class="col-xs-12 col-md-10 col-md-offset-1">
              <h1 align="center">Generate language model</h1>
              <p>New language model will be generated by all sentences</p>
