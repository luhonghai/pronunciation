...
<style>
  ...
  .cbstyle{
    box-shadow: inset 0 1px 1px rgba(255, 250, 250, 0.075);
    width: 10%;
  }
  .lbl_addForm{
    font-weight: 200;
              ...
              <div class="dropdown-menu dropdown-menu-right" role="menu">
                <form class="form-horizontal" role="form">
                  <div class="form-group">
                    ...
                    <input placeholder="Enter company name" class="form-control" type="text" />
                  </div>
                  <div class="form-group">
                    <label for="contain">Course title</label>
                    <input placeholder="Enter course title" class="form-control" type="text" />
                  </div>
                  <div class="form-group">
      ...
      <div class="modal-body">
        <form class="form-horizontal" name="addform">
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" class="form-control" id="name" name="" placeholder="Course name">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-4 lbl_addForm" for="description">Description:</label>
            <div class="col-md-6">
              <textarea rows="3" class="form-control" id="description" name="comments" placeholder="Description"></textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="checkbox" class="form-control cbstyle"
                     id="shareall" name="share" value="all">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="checkbox" style="padding-top: 10px" class="form-control cbstyle"
                     id="mycompany" name="share" value="my company">
            </div>
          </div>
          <div class="form-group">
