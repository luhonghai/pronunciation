...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (mDismissOnTouch || (mDismissOnTouchOutSide && isOutOfBounds(event))) {
            hide();
        }
        return true;
    }
    ...
    private boolean isOutOfBounds(MotionEvent event) {
        ...
        mContentBox.getHitRect(dialogBounds);
        return (!dialogBounds.contains((int) event.getX(), (int) event.getY()));
    }
    ...
    public void setContentHtml(String html) {
        if (mContentTextView != null) {
            mContentTextView.setHtmlFromString(html, true);
        }
    }
    ...
    public void setContentTextColor(int textColour) {
        if (mContentTextView != null) {
    ...
    public static class Builder {
        ...
        public Builder setContentHtml(String html) {
            showcaseView.setContentHtml(html);
            return this;
        }
        ...
        public Builder setDismissOnTouchOutSide(boolean dismissOnTouchOutSide) {
            showcaseView.setDismissOnTouchOutSide(dismissOnTouchOutSide);
            return this;
        }
