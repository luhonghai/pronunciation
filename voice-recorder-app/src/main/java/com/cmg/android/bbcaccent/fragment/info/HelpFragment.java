...
public class HelpFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View root = inflater.inflate(R.layout.help, null);
        ...
        pagerHelpContent = (ViewPager) root.findViewById(R.id.pagerHelpContent);
        pagerHelpContent.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == HELP_CONTENT_LENGTH - 1) {
                    ((TextView) root.findViewById(R.id.btnSkip)).setText(getString(R.string.dialog_close));
                } else {
                    ((TextView) root.findViewById(R.id.btnSkip)).setText(getString(R.string.skip));
                }
            }
        ...
        HelpPageAdapter pageAdapter = new HelpPageAdapter(getChildFragmentManager(), imageLoadingListener);
        ...
        if (userProfile != null && userProfile.getHelpStatus() == UserProfile.HELP_INIT) {
            Preferences.setHelpStatusProfile(MainApplication.getContext(), userProfile.getUsername(), UserProfile.HELP_SKIP);
        }
        return root;
    }
    ...
    public void onDestroyView() {
        ...
        Preferences.setIsSetupProfile(MainApplication.getContext(), Preferences.getSelectedUsername(MainApplication.getContext()));
    }
    ...
    public class HelpPageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            HelpFragmentItem helpFragment = new HelpFragmentItem();
    ...
    public static class HelpFragmentItem extends Fragment {
