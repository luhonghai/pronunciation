package com.cmg.android.bbcaccent.view.spinner;
...
//        defaultArray.recycle();
        ...
        baseColor = array.getColor(R.styleable.MaterialSpinner_ms_baseColor, Color.TRANSPARENT);
        highlightColor = array.getColor(R.styleable.MaterialSpinner_ms_highlightColor, Color.TRANSPARENT);
        errorColor = array.getColor(R.styleable.MaterialSpinner_ms_errorColor, Color.TRANSPARENT);
