...
# Program takes one phrase at a time and splits wav file into individual phonemes
# .phseg file is required for boundary detection
# complete phone list with out filler phones is required to avoid them
# out split directory to be mentioned
