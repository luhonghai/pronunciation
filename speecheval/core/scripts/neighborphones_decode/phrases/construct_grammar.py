...
# Program takes input .phseg file and constructs gramar wih neighboring phones 
# each time with all other phones in the phrase fixed

if len(sys.argv) != 3:
        print '\n Usage: python construct_grammar.py <input_phoneseg_file> <nbg_key_mapper> \n'
        sys.exit(1)
